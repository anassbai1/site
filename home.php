...
<body>
  ...
  <header>
    <a href="home.php" class="logo"><img src="LOGO LRTI1.png" width="140px"></a>
    ...
    <nav class="navbar">
      ...
      <li><a href="#">Who are we ? <i class="fa-solid fa-caret-down"></i></a>
        <ul>
          <li><a href="presentation en.php">Presentation</a></li>
          <li><a href="tuyauterieEN.php">piping and boilermaking</a></li>
          <li><a href="qualiteEN.php">Safety and quality</a></li>
          
        </ul>
      </li>

       <li><a href="#">realization <i class="fa-solid fa-caret-down"></i></a>
        <ul>
          <li><a href="skid.php">Injection skid</a></li>
          <li><a href="pomperie.php">Pumpery</a></li>
          <li><a href="chargement.php">Charging station</a></li>
          <li><a href="rack.php">Aerial Rack</a></li>
          <li><a href="inox.php">Inox</a></li>
          <li><a href="atelier.php">in workshop</a></li>
          <li><a href="manchete.php">SEA LINE cuff</a></li>
          <li><a href="raccordement.php">Raccordement</a></li>
          <li><a href="projet.php">creation before project</a></li>
          
        </ul>
      </li>
      <li><a href="contactEN.php">Contact</a></li>
      <li><a href="recrutementEN.php">recruitment</a></li>
  ...
  <figure><br><br>
   <div class="slider-container">
    <div class="slider-wrapper">
        <div class="slidee"> <P>The Languedoc Roussillon Travaux Industriels company specializes in the construction and installation of pipe networks and metal structures, supporting you throughout your projects in France, Europe and throughout the world. Customer satisfaction is the heart of our company policy.</P><img src="36.jpg" alt="Imagen 1"></div>
...
<div class="ktab">
  <h2>About</h2>
  <p>With its expertise, LRTI is a key company in the industrial sector.
    <div class="cv">
      <p>The Languedoc Roussillon Travaux Industriels company specializes in the construction and installation of pipe networks and metal structures, supporting you throughout your projects in France, Europe and throughout the world.
    </div>
       </p><br><br>
</div>
...
<div class="po">
    <div class="zz">
       <p>Founded in 1996, the Languedoc Roussillon Travaux Industriels company specializes in the construction and installation of pipe networks and metal structures.<br>
...
<br><br><br>
    ...
    <div class="lo">
      <p>
Our culture Quality Health Safety Environment</p>
      <div class="vertical-line"></div>
      <span>The MÉTIS group specializes in the study, construction and installation of
piping networks are committed daily to improving their
results.
Our ambition is to sustainably achieve excellence in safety, quality and
economic performance through collective commitment in interaction with our
stakeholders and serving our customers.
Our QSSE policy is the transcription of our commitments in terms of
prevention of safety, health and environmental preservation.
It defines the orientations and objectives concerning these areas.
It involves prevention (risk analysis
single document), the
training and involvement of staff in achieving objectives, management
dangerous situations, analysis and feedback from accidents as well as
as compliance with the legislation and regulations in force.
Management asks its employees to adhere to this policy and show their
involvement in all different areas.</span>
      
    </div>
<div class="container font-weight-bold">
                <h2 class="text-center font-weight-bold">Our Parteners</h2>
